    ...
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3">
        ...
        <Button
          ...
          size="sm"
          variant="outline"
          className="h-7 px-2 text-xs gap-1 border-gray-200 text-gray-600 hover:border-[#2563EB] hover:text-[#2563EB]"
        >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex gap-2 text-xs text-gray-400 mt-0.5">
                ...
                {cargaItem.quantidade > 1 && (
                  <span className="text-[#2563EB] font-medium">×{cargaItem.quantidade}</span>
                )}
              </div>
            </div>
            <button
              ...
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-lg border p-3 text-left transition-colors ${
                  alreadyAdded
                    ...
                    : "border-gray-200 hover:border-[#2563EB] hover:bg-blue-50/50"
                }`}
              >
                <div
      ...
      <CardContent>
        {MOCK_COTACOES.length > 0 ? (
            ...
            {MOCK_COTACOES.map((cotacao) => (
              <div key={cotacao.id} className="rounded-lg border border-gray-200 p-3 space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-[#2563EB]">{formatCurrency(cotacao.valor)}</span>
                </div>
                <div className="flex items-center gap-3 text-xs text-gray-500">
                  <span>Prazo: {cotacao.prazoEntrega}</span>
                  <span>Avaliação: {cotacao.avaliacao} / 5</span>
                </div>
                <Button size="sm" className="w-full h-7 text-xs bg-[#2563EB] text-white hover:bg-blue-700 mt-1">
                  Aceitar cotação
                </Button>
              </div>
            ))}
          ...
          <div className="flex flex-col items-center py-4 text-center gap-3">
            ...
            <Button size="sm" className="bg-[#F59E0B] text-white hover:bg-amber-500 h-8 px-4 text-xs">
              Solicitar cotações
            </Button>
          </div>
        )}
    ...
    <div className="flex flex-col gap-6 px-8 py-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Button
          ...
          className="gap-2 bg-[#2563EB] text-white hover:bg-blue-700 shrink-0"
          size="sm"
        >
          <Plus className="h-4 w-4" />
          Adicionar item
